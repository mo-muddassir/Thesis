...
#read data
den_eq_lgbh = np.loadtxt('/home/moe/research/Thesis/analysis/equal_large_bh_final.den', unpack=True)
vel_eq_lgbh = np.loadtxt('/home/moe/research/Thesis/analysis/equal_large_bh_final.vel', unpack=True)
...
plt.savefig("Large_BH_Profiles.pdf")
plt.show()

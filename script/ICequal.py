...
#read data
ic_den = np.loadtxt('/home/moe/research/Thesis/analysis/equal_ic.den', unpack=True)
ic_vel = np.loadtxt('/home/moe/research/Thesis/analysis/equal_ic.vel', unpack=True)
...
plt.savefig("Equal_mass_IC_Profiles.pdf")
plt.show()

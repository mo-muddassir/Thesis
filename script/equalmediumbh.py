...
#read data
den_eq_mdbh = np.loadtxt('/home/moe/research/Thesis/analysis/equal_med_bh_final1.den', unpack=True)
vel_eq_mdbh = np.loadtxt('/home/moe/research/Thesis/analysis/equal_med_bh_final1.vel', unpack=True)
...
r_ad, rho_ad,phi_ad, vr2_ad, vt2_ad, rhostar_ad, phistar_ad, vr2star_ad, vt2star_ad = np.loadtxt('/home/moe/research/Thesis/outputs/pred_01m.txt', unpack = True)
...
axs[0].scatter(den_eq_mdbh[0],den_eq_mdbh[1], color='red', marker='.', label='Medium BH (Mbh/M = 0.01)')
axs[1].scatter(vel_eq_mdbh[0],vel_eq_mdbh[1], color='red', marker='.', label='Medium BH (Mbh/M = 0.01')
...
plt.savefig("Medium_BH_Profiles.pdf")
plt.show()
